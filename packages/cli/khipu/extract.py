...
Model: ``gemini-2.5-flash`` (the plan's P1 cloud role), keyed the same way as
embeddings (Keychain / env / file via ``khipu.keychain``). No SDK — one REST call.
"""
...
MODEL = os.environ.get("KHIPU_EXTRACT_MODEL", "gemini-2.5-flash")
